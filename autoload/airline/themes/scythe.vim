...
let g:airline#themes#neutral#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
...
let g:airline#themes#neutral#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)

let g:airline#themes#neutral#palette.normal.airline_warning = s:warning
let g:airline#themes#neutral#palette.insert.airline_warning = s:warning
let g:airline#themes#neutral#palette.visual.airline_warning = s:warning
let g:airline#themes#neutral#palette.replace.airline_warning = s:warning

let g:airline#themes#neutral#palette.normal.airline_error = s:error
let g:airline#themes#neutral#palette.insert.airline_error = s:error
let g:airline#themes#neutral#palette.visual.airline_error = s:error
let g:airline#themes#neutral#palette.replace.airline_error = s:error
